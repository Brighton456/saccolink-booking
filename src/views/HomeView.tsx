      ...
      {filtered.length === 0 ? (
        ...
        filtered.map((i) => (
          <button
            ...
            className="flex w-full cursor-pointer items-center gap-3 border-b border-[var(--scl-border)] px-4 py-3.5 text-left text-sm font-medium text-[var(--scl-text)] transition hover:bg-[#16a34a]/5 last:border-0"
          >
...
function TripCountdown() {
  ...
  return (
    <div className="mx-auto mb-8 flex w-full max-w-sm items-center justify-center gap-3 rounded-2xl border border-[#16a34a]/20 bg-[#16a34a]/5 px-6 py-4">
      <I.Calendar className="h-5 w-5 text-[#16a34a]" />
      ...
      <div className="flex items-center gap-1">
        {[
          ...
          <span key={label} className="rounded-lg bg-[#16a34a] px-2 py-1 text-xs font-bold text-white tabular-nums">
...
export default function HomeView() {
  ...
  return (
    <div className="flex min-h-screen flex-col animate-fade-in pb-bottom-nav">
      {/* Hero — Android Material style */}
      <div className="relative overflow-hidden bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] px-4 pt-20 pb-40 md:pt-28 md:pb-48">
        {/* Decorative shapes */}
        <div className="absolute -right-20 -top-20 h-64 w-64 rounded-full bg-[#16a34a]/10 blur-3xl" />
        <div className="absolute -bottom-10 -left-10 h-40 w-40 rounded-full bg-[#22c55e]/10 blur-2xl" />
        <div className="absolute right-10 top-16 h-2 w-2 rounded-full bg-[#22c55e] animate-pulse-soft" />
        <div className="absolute left-20 top-24 h-1.5 w-1.5 rounded-full bg-[#16a34a] animate-pulse-soft" style={{ animationDelay: "0.5s" }} />
        ...
        <div className="relative z-10 mx-auto max-w-7xl text-center">
          ...
          <h1 className="mb-4 text-4xl font-extrabold tracking-tight text-white md:text-6xl">
            Travel<br className="md:hidden" /> <span className="bg-gradient-to-r from-[#22c55e] to-[#86efac] bg-clip-text text-transparent">Comfortable.</span>
          </h1>
            ...
            {[
              ...
              <button
                ...
                className={`flex flex-1 items-center justify-center gap-2 py-4 text-center text-sm font-bold transition-all md:py-5 md:text-base ${
                  activeTab === key
                    ? "border-b-[3px] border-[#16a34a] bg-[var(--scl-card)] text-[#16a34a]"
          ...
          <div className="p-5 md:p-8">
            {activeTab === "shuttle" ? (
              <div className="space-y-4">
                ...
                <div className="flex flex-col items-center gap-3 md:flex-row">
                  ...
                  <div className="relative w-full md:w-1/3">
                    ...
                    <div className="flex items-center rounded-2xl border-2 border-[var(--scl-border)] bg-[var(--scl-surface-alt)] px-4 py-3.5 transition-all hover:border-[#16a34a]/50 focus-within:border-[#16a34a] focus-within:bg-[var(--scl-card)] focus-within:shadow-md focus-within:shadow-[#16a34a]/5">
                  ...
                  <button
                    onClick={swap}
                    className="haptic-tap flex h-12 w-12 items-center justify-center rounded-full border-2 border-[#16a34a]/20 bg-[#16a34a]/5 text-[#16a34a] transition-all hover:bg-[#16a34a] hover:text-white hover:shadow-lg hover:shadow-[#16a34a]/20 md:mt-6"
                  >
                  ...
                  <div className="w-full md:w-1/4">
                    ...
                    <div className="flex items-center rounded-2xl border-2 border-[var(--scl-border)] bg-[var(--scl-surface-alt)] px-4 py-3.5 transition-all hover:border-[#16a34a]/50 focus-within:border-[#16a34a] focus-within:bg-[var(--scl-card)]">
                  ...
                  <div className="w-full md:w-auto md:mt-6">
                    <button
                      onClick={search}
                      className="haptic-tap w-full rounded-2xl bg-gradient-to-r from-[#22c55e] to-[#16a34a] px-8 py-4 text-lg font-bold text-white shadow-lg shadow-[#16a34a]/25 transition-all hover:-translate-y-0.5 hover:shadow-xl hover:shadow-[#16a34a]/30 active:scale-[0.98] md:w-auto"
                    >
                      Find Seats
                    </button>
                  </div>
                    ...
                    <div className="flex gap-2 overflow-x-auto pb-1">
                      {favoriteRoutes.map((fav, i) => (
                        <button
                          ...
                          className="haptic-tap shrink-0 rounded-xl border border-[var(--scl-border)] bg-[var(--scl-surface-alt)] px-4 py-2.5 text-xs font-semibold text-[var(--scl-text)] transition hover:border-[#16a34a]/30 hover:bg-[#16a34a]/5"
                        >
              ...
              <div className="py-8 text-center">
                <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-[#16a34a]/10 text-[#16a34a]">
                ...
                <div className="mx-auto flex max-w-sm overflow-hidden rounded-2xl border-2 border-[var(--scl-border)] focus-within:border-[#16a34a]">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            {[
              ...
              { icon: <I.Shield className="h-6 w-6" />, title: "Secure Payment", desc: "Pay with M-Pesa directly from your phone.", color: "from-[#16a34a] to-[#22c55e]" },
